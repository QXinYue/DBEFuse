...
class DenseBlock(nn.Module):
    def __init__(self):
        ...
        self.Temp = TripletAttention(c1=None, c2=None, no_spatial=False)
...
class DetailFeature(nn.Module):
    ...
    def forward(self, x):
        ...
        for layer in self.net:
            z1, z2 = layer(z1, z2)
        output = self.Temp(torch.cat((z1, z2), dim=1))
        return output
...
# Normalisation Mean = 0 Variances = 1
